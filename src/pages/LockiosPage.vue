<template>
    ...
    <div
      ...
      <div class="flex flex-col w-1/4">
        <button
            ...
            @click="useLockio(lockioSelected.id)"
  ...
  <div v-else>
    Code : {{ lockioCode }} pour le Lockio n°{{ lockioSelected.id }}
    <br>
    <button class="bg-gray-600 hover:bg-gray-800 mt-8 text-white font-bold py-4 px-16 rounded-xl text-xl"
            @click="reset()">
      Retourner aux Lockios
    </button>
  </div>
